...
public class NieAktualne extends Query{
	...
	public NieAktualne() {
		super("SELECT distinct C.NAME NAZWA, C.TELNUM TELNUM, E.ENAME PRACOWNIK, O.ID_ORDER NRZAM, o.problem as status, O.MODEL MODEL, O.FINISHDATE DATA, O.FINISHTIME CZAS\n" +
